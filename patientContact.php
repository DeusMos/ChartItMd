                ...
                <table class="striped">
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="address1"
                                   id="address1" <?php echo 'value="' . $array[0]['address1'] . '"' ?> disabled></td
                    </tr>
                    <tr>
                        <td>Address 2:</td>
                        <td><input type="text" name="address2"
                                   id="address2" <?php echo 'value="' . $array[0]['address2'] . '"' ?> disabled></td>
                    </tr>
                    <tr>
                        <td>Phone number</td>
                        <td><input type="tel" name="phone" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}"
                                   id="phone" <?php echo 'value="' . $array[0]['phone'] . '"' ?> disabled></td>
                    </tr>
                    <tr>
                        <td>Email</td>
                        <td><input type="email" name="email"
                                   id="email" <?php echo 'value="' . $array[0]['email'] . '"' ?> disabled></td>
                    </tr>
